...
@section('title')
Inventario UEPS - Último en Entrar, Primero en Salir
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                <i class="fas fa-boxes text-success"></i> Inventario UEPS (Último en Entrar, Primero en Salir)
                            </h4>
                        ...
                        <div class="card-body" style="min-height: 400px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <a href="{{ route('inventario.create') }}?metodo=UEPS" class="btn btn-success">
                                        <i class="fas fa-plus"></i> Agregar Inventario UEPS
                                    </a>
                                </div>
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" class="form-control" id="search-input" placeholder="Buscar productos UEPS...">
                            ...
                            <div class="mt-4">
                                <h5>Información del Método UEPS:</h5>
                                <div class="alert alert-success">
                                    <strong>UEPS (Último en Entrar, Primero en Salir):</strong> Este método asume que los últimos productos que entran al inventario son los primeros en salir. Los costos de venta se basan en los costos más recientes disponibles.
                                </div>
                            </div>
                            @endif
                        </div>
...
<script>
    ...
    function confirmDelete(id) {
        if (confirm('¿Está seguro de que desea eliminar este producto del inventario UEPS?')) {
