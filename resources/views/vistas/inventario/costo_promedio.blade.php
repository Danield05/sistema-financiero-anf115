                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                <i class="fas fa-boxes text-info"></i> Inventario Costo Promedio
                            </h4>
                        ...
                        <div class="card-body" style="min-height: 400px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" class="form-control" id="search-input" placeholder="Buscar productos costo promedio...">
                            ...
                            <div class="mt-4">
                                <h5>Información del Método Costo Promedio:</h5>
                                <div class="alert alert-info">
                                    <strong>Costo Promedio:</strong> Este método calcula el costo promedio ponderado de todos los productos disponibles en inventario. El costo de venta es uniforme para todas las unidades del mismo producto.
                                </div>
                            </div>
                            @endif
                        </div>
...
<script>
    ...
    function confirmDelete(id) {
        if (confirm('¿Está seguro de que desea eliminar este producto del inventario costo promedio?')) {
